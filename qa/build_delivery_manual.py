...
def build():
    ...
    add_para(document, "顶部是操作流程按钮，左侧是字段/投票结果/格式刷，右侧是模板预览，底部是数据预览和操作记录。")
    ...
    steps = [
        ...
        "点击“3 设置模板”，在左侧选择字段或投票结果，再在右侧模板预览中点击判断区和标记区。",
        "点击“4 确认设置”。",
    ...
    add_heading(document, "四、模板设置要点", 1)
    bullets = [
    ...
    qas = [
        ...
        ("可以重复调整吗？", "可以。导出前预览点“返回修改”，或点击“上一步”“重置”重新调整。"),
    ]
    for q, a in qas:
